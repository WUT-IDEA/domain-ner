...
from is13.rnn.ernn_elman import model
...
if __name__ == '__main__':
    ...
    # alltrain_x = get_datalist('is13/data/newxRBFfinal.txt')
    # alltrain_y = get_datalist('is13/data/newyRBFfinal.txt')
    
    # train_lex=alltrain_x[0:36956]
    # test_lex=alltrain_x[36956:]
    # train_y = alltrain_y[0:36956]
    # test_y = alltrain_y[36956:]
    # ribao_x=train_lex
    # ribao_y = train_y
    alltrain_x = get_datalist('is13/data/sougou/trainx.txt')
    alltrain_y = get_datalist('is13/data/sougou/trainy.txt')
    # ribao_x=get_datalist('sorted_xRBF_3300.txt')
    # ribao_y = get_datalist('sorted_yRBF_3300.txt')
    ...
    for e in xrange(s['nepochs']):
        ...
        for i in xrange(nsentences):
            ...
            ribao_labels=train_y[i]
            # ribao_cwords = contextwin(ribao_x[i], s['win'])
        ...
        if res_test['f1'] > best_f1:
            ...
            if s['verbose']:
                ...
                f = open('sougou-resultERNN.txt', 'a')
                f.write(tempstr + '\n')
                f.close()
    ...
    # zhengzhi_idx = get_datalist('is13/data/exp/new_pretrainx.txt')
    ...
    # zhengzhi_predx = open('is13/data/exp/rnn_predx.txt', 'w') #zhengzhi_idx after sorted
    # zhengzhi_predy = open('is13/data/exp/rnn_predy.txt', 'w')
    ...
    #     if topk>799: break       #predict top800
