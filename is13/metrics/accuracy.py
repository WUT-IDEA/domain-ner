...
from is13.examples.evaluate import my_evaluate
...
def get_perf(filename):
  ...
  #download('http://www-etud.iro.umontreal.ca/~mesnilgr/atis/conlleval.pl')
    ...
    proc = subprocess.Popen(["perl", _conlleval, "-r"], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
...
def my_conll(p, g, w, filename):
    ...
    return my_evaluate(filename)


if __name__ == '__main__':
    print get_perf('../examples/elman-train/current.test.txt')
    # print get_perf('best.valid.txt')
